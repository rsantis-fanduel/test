...
import static com.fanduel.external.client.paddypower.PPApaClientModule.createTimeLimiterRegistry;
...
public class CircuitedTimeLimitedPPApaClientImplTest extends ResilientPPApaClientImplTest {
	...
	ResilientPPApaClientImpl createClient( final PPApaClient delegate, final Config config ) {
		return new ResilientPPApaClientImpl( delegate, createCircuitBreakerRegistry( config ), true,
	...
	void openCircuitOnTimeOuts() {
		...
		final ResilientPPApaClientImpl client = createClient( delegate, config );
