...
@TransferClass
public class CancelBetResponse extends BtoBetResponse {
	...
	public boolean equals( final Object o ) {
		...
		final CancelBetResponse that = (CancelBetResponse) o;
	...
	public static class Builder extends BtoBetResponse.Builder {
		...
		public CancelBetResponse build() {
			return new CancelBetResponse( this );
		}
	}

	public CancelBetResponse() {}

	public CancelBetResponse( final Builder builder ) {
		super( builder );
