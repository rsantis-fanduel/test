...
import com.fanduel.external.client.paddypower.impl.jaxws.generated.gap.CancelTransferRequestType;
import com.fanduel.external.client.paddypower.transfer.TransferRequest;
import com.fanduel.transform.Transformer;

public class TransferRequestToGapCancelTransformer implements Transformer<TransferRequest, CancelTransferRequestType> {
